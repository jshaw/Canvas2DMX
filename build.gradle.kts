...
if(currentOS.isMacOsX) {
    sketchbookLocation = if (File("$userHome/Documents/Processing4/sketchbook").isDirectory) {
        "$userHome/Documents/Processing4/sketchbook"
    } else {
        "$userHome/Documents/Processing4"
    }
    ...
    sketchbookLocation = if (File(docsFolder,"Processing4/sketchbook").isDirectory) {
        "$docsFolder/Processing4/sketchbook"
    } else {
        "$docsFolder/Processing4"
    }
} else {
