...
<div class="project-grid">
  ...
  <a class="project-card" href="https://www.jordanshaw.com/home/constellation-range">
    ...
    <div class="project-card-body">
      ...
      <p class="project-card-desc">Six illuminated faceted peaks with aurora gradients responding to Bluetooth proximity — ~2,000 LEDs. Lumière: The Art of Light at Trillium Park and OCAD U Gala 2026</p>
    </div>
  </a>
